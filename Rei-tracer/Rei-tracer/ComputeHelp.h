...
private:
	...
	bool Init(LPCWSTR shaderFile, LPCWSTR blobFileAppendix, char* pFunctionName, D3D10_SHADER_MACRO* pDefines,
...
public:
	...
	ComputeShader* CreateComputeShader(LPCWSTR shaderFile, LPCWSTR blobFileAppendix, char* pFunctionName, D3D10_SHADER_MACRO* pDefines);
